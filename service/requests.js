...
const urlCars = `https://bestcars-nodejs-server.onrender.com/jsonstore/cars/`;
const urlLikes = `https://bestcars-nodejs-server.onrender.com/data/likes/`
...
export function registerUser(user) {
    fetch('https://bestcars-nodejs-server.onrender.com/users/register/', {
        method: 'POST',
        headers: {
...
export function loginUser(user) {
    fetch('https://bestcars-nodejs-server.onrender.com/users/login/', {
        method: 'POST',
        headers: {
            'content-type': 'application/json'
        },
...
export const logoutUser = () => {
    fetch('https://bestcars-nodejs-server.onrender.com/users/logout/', { headers: { 'X-Authorization': token() } });
}
